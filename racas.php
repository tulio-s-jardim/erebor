					...
					<table class="table">
					  ...
					  <tbody>
					    ...
					    <tr>
					      ...
					      <td>
							<button class="btn btn-sm btn-primary" onclick="appear('eRaca<?php echo $r[$i]->id ?>', <?php echo $rM ?>);">Editar</button>
							<button class="btn btn-sm btn-danger" onclick="appear('dRaca<?php echo $r[$i]->id ?>', <?php echo $rM ?>);">Excluir</button>
					    </tr>
						<?php } ?>
					  </tbody>
					</table>
