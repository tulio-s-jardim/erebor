					...
					<table class="table">
					  ...
					  <tbody>
					    ...
					    <tr>
					      ...
					      <td>
							<button class="btn btn-primary" onclick="appear('eRaca<?php echo $cnr[$i]->id ?>');">Editar</button>
							<button class="btn btn-danger" onclick="appear('dRaca<?php echo $cnr[$i]->id ?>');">Excluir</button>
					    </tr>
						<?php } ?>
					  </tbody>
					</table>
